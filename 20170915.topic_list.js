...
page_configurations = {
	...
	'jawiki:Wikipedia:井戸端' : Object.assign({
		...
		postfix : function(section_table) {
			...
			section_table.push('{| class="wikitable" style="float:left;"',
					'| style="background-color:#efe;" | 一時間以内', '|-',
					'| style="background-color:#eef;" | 一日以内', '|-',
					'| 一日以上、一週間まで', '|-',
					'| style="background-color:#ddd;" | 一週間以上', '|-',
					'| style="background-color:#bbb;" | 一ヶ月以上', '|-', '|}',
					'{{-}}');
		},
