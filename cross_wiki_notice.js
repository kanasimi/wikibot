...
// CeL.set_debug(2);
if (false) {
	wiki.page('User_talk:Kanashimi', function(page_data) {
...
wiki.page('User_talk:' + owner_name, function(page_data) {
	...
	zhwiki.page('User_talk:' + owner_name, check_talk_page);
	...
	function check_talk_page(page_data) {
		...
		zhwiki.edit(': ' + user + ' 於 ' + revision.timestamp
				+ ' 在 [https://zh.moegirl.org/User_talk:' + owner_name
				+ ' moegirl] 發了一則新留言，煩請撥空前往查看。 --~~~~', {
			section : 'new',
			...
			wiki.page('User_talk:' + owner_name).edit(function(page_data) {
				var
				/**
