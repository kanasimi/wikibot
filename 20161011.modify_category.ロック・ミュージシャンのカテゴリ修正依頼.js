...
// should add 転送ページ
PATTERN_ロック = /\| *(?:Genre|ジャンル) *=[^=\|{}]*?\[\[(?:ロック(?: \(音楽\)|音楽|ミュージック)?|ロックン・?ロール|ハード・?ロック(?:バンド)?|Hard rock|パンク(・?ロック|・?バンド|ロック| \(音楽\)|音楽|ミュージック)?|Punk rock|ロンドン・?パンク|ヘヴィ・?メタル|Heavy Metal|アート・?ロック|インディー・?ロック|AOR|エクスペリメンタル・?ロック|オルタナティヴ・?ロック|ガレージロック|カントリーロック|クラウトロック|クラシック・?ロック|グラムロック|クリスチャン・?ロック|ゴシック・?ロック|サイケデリック・?ロック|サザン・?ロック|ジャズ・?ロック|シンフォニック・?ロック|スタジアム・?ロック|ストーナーロック|スペース・?ロック|ソフトロック|デジタルロック|パブロック|バロック・?ポップ|パワー・?ポップ|ピアノ・?ロック|フォークロック|ブルースロック|プログレッシヴ・?ロック|プンタ・?ロック|ポップ・?ロック|ラーガ・?ロック|ラップロック|リバプールサウンド|ロカビリー) *(?:\]\]|\|)/;
