...
// 2017/12/19 6:19:55 Request for Kanashimi to run cewbot on some articles.
page_list = 'Draft:List of the Cenozoic life of Alabama|Draft:List of the Cenozoic life of Alaska|Draft:List of the Cenozoic life of Arizona|Draft:List of the Cenozoic life of Arkansas|Draft:List of the Cenozoic life of California|Draft:List of the Cenozoic life of Colorado|Draft:List of the Cenozoic life of Connecticut|Draft:List of the Cenozoic life of Delaware|Draft:List of the Cenozoic life of Florida|Draft:List of the Cenozoic life of Georgia (U.S. state)|Draft:List of the Cenozoic life of Hawaii|Draft:List of the Cenozoic life of Idaho|Draft:List of the Cenozoic life of Illinois|Draft:List of the Cenozoic life of Indiana|Draft:List of the Cenozoic life of Iowa|Draft:List of the Cenozoic life of Kansas|Draft:List of the Cenozoic life of Kentucky|Draft:List of the Cenozoic life of Louisiana|Draft:List of the Cenozoic life of Maine|Draft:List of the Cenozoic life of Maryland|Draft:List of the Cenozoic life of Massachusetts|Draft:List of the Cenozoic life of Michigan|Draft:List of the Cenozoic life of Minnesota|Draft:List of the Cenozoic life of Mississippi|Draft:List of the Cenozoic life of Missouri|Draft:List of the Cenozoic life of Montana|Draft:List of the Cenozoic life of Nebraska|Draft:List of the Cenozoic life of Nevada|Draft:List of the Cenozoic life of New Hampshire|Draft:List of the Cenozoic life of New Jersey|Draft:List of the Cenozoic life of New Mexico|Draft:List of the Cenozoic life of New York (state)|Draft:List of the Cenozoic life of North Carolina|Draft:List of the Cenozoic life of North Dakota|Draft:List of the Cenozoic life of Ohio|Draft:List of the Cenozoic life of Oklahoma|Draft:List of the Cenozoic life of Oregon|Draft:List of the Cenozoic life of Pennsylvania|Draft:List of the Cenozoic life of Rhode Island|Draft:List of the Cenozoic life of South Carolina|Draft:List of the Cenozoic life of South Dakota|Draft:List of the Cenozoic life of Tennessee|Draft:List of the Cenozoic life of Texas|Draft:List of the Cenozoic life of Utah|Draft:List of the Cenozoic life of Vermont|Draft:List of the Cenozoic life of Virginia|Draft:List of the Cenozoic life of Washington (state)|Draft:List of the Cenozoic life of West Virginia|Draft:List of the Cenozoic life of Wisconsin|Draft:List of the Cenozoic life of Wyoming'
		.split('|').slice(0);
		...
		parser.each('template', function(token, index) {
			...
			if (typeof image_file !== 'string') {
				...
				if (some_tokens_is_not_string) {
					CeL.error('scan_link_target: '
					// wrong link?? TODO: [[Lithophyllum]]
					+ CeL.wiki.title_link_of(linked_page_data) + '@'
							+ CeL.wiki.title_link_of(page_data)
							+ ': parameters.image is not string: has type '
							+ some_tokens_is_not_string);
					CeL.log(String(image_file));
